...
const HomeCard = () => {
 return (
  <div className="bg-background border-2 border-b-4 rounded-md w-full h-full hover:border-b-emerald-500 focus-within:border-b-emerald-500 transition-[border] duration-300 ease-in-out relative">
   <CardModal />
